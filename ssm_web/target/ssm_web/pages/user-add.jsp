                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input id="userName" onchange="VerificationUsername()" type="text" class="form-control"
                                   name="username"
...
<script type="text/javascript">
    function VerificationUsername() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/user/saveUI", //处理页面的路径
            data: {"username": username}, //要提交的数据是一个JSON
            type: "POST", //提交方式
