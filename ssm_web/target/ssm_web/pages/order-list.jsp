			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<!--工具栏/-->
                         <form id="delManyForm" action="${pageContext.request.contextPath}/order/delMany" method="post">
						<!--数据列表-->
						<table id="dataList"
							...
							<c:forEach items="${pageInfo.list}" var="order">
								<tr>
									...
									<td>${order.payType==1?"微信支付":order.payType==0?"支付宝":"其他"}</td>
									<td>${order.orderStatus==1?"已支付":"为支付"}</td>
									...
									<td class="text-center">
										...
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/pages/order-update.jsp"'>修改</button>
									</td>
								</tr>
							</c:forEach>
							</tbody>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="javascript:toPage(${pageInfo.pages})" aria-label="Next">尾页</a></li>
						</ul>
					</div>
