...
<%--jstl: 核心库（c标签）, sql语句格式库，格式化库，函数库，国际化库（i18n）--%>
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<table id="dataList"
							...
							--%>
							<tbody>
							<c:forEach items="${productPageBean.pageList}" var="product">
								<tr>
...
<%--									<td>${product.departureTime}</td>--%>
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${productPageBean.totalPage}页，共${productPageBean.totalCount} 条数据。 每页 <select onchange="toPage(1)" id="PageS" class="form-control">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="javascript:toPage(${productPageBean.pageNum -1})">上一页</a></li>
							<c:forEach begin="1" end="${productPageBean.totalPage}" var="i">
								<c:if test="${productPageBean.pageNum == i}">
							...
							<li><a href="javascript:toPage(${productPageBean.pageNum + 1})">下一页</a></li>
							<li><a href="javascript:toPage(${productPageBean.totalPage})" aria-label="Next">尾页</a></li>
						</ul>
					</div>
	...
	<script type="text/javascript">
		  ...
		  function toPage(pageNum) {
		      ...
		      if(pageNum > ${productPageBean.totalPage})
              {
              	alert("已经是最后一页了!")
                  return;
              }
